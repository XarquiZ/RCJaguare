...
input_dir = "images/fotos/Novembro azul 2025"
output_dir = "images/otimizadas/novembro-azul-2025"
...
# Ignore duplicates added by macOS sometimes like '._' prefixes
files = [f for f in files if not f.startswith("._")]

total = len(files)
print(f"Iniciando conversão WebP de {total} fotos do Novembro Azul 2025...")
...
print("🎉 Lote Novembro Azul 2025 otimizado com sucesso para WebP!")
