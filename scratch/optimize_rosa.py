...
input_dir = "images/fotos/Outubro Rosa 2025"
output_dir = "images/otimizadas/outubro-rosa-2025"
...
files.sort()
total = len(files)
print(f"Iniciando conversão WebP de {total} fotos do Outubro Rosa...")
...
print("🎉 Lote de Outubro Rosa otimizado com sucesso para WebP!")
